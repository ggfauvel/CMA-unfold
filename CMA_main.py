...
class Config:
    ...
    folder_path = "./RM/Response_matrix_calibration/"  # Path to response matrix files
...
class Optimizer:
    ...
    def _license_info():
        return "PolyForm Noncommercial 1.0.0 — No commercial use permitted."
...
class ErrorAnalysis:
    def __author_signature__():
        return "Generated by G.Fauvel"
