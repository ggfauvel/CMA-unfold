...
*      momentum_energy = sample_histogram_momentum_energy( [filename], [unit] )
      ...
      momentum_energy = sample_spectrum_momentum_energy("Spectrum_b.txt", "GeV")
...
*      call sample_exponential_energy_weight( [e_min], [e_max], [intensity_ratio], momentum_energy, particle_weight )
      ...
      divergence_x = 0.0000001
      divergence_y = 0.0000001
...
*      gaussian_divergence_logical_flag = .true.
      ...
      coordinate_x = sample_flat_distribution( -1.5D0, 1.5D0 )
      coordinate_y = sample_flat_distribution( -1.5D0, 1.5D0 )
      coordinate_z = -3D0
